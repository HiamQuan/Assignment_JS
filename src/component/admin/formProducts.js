const FormProduct = {
  print(result) {
    ...
    <div class="w-full min-h-screen bg-gray-600 px-60 flex flex-col items-start">
        ...
        <form class=" w-full h-full" id="form-post">    
            ...
            <img id="img-preview" class="h-16 w-16 object-cover bg-gray-200" src=""  alt="" />
            </div>
            <input id="file-upload" class="p-2 block w-full mt-4 text-sm text-gray-900 bg-gray-200 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 file:mr-4 file:py-1 file:px-4
            ...
            <div class="px-4 py-3 bg-gray-600 text-center sm:px-6">
              <button id="btn-submit" data-id= ${result !== null ? result.id : ''} type="submit" class="inline-flex justify-center py-2 px-4 border border-indigo-600 shadow-sm text-base font-medium rounded-md text-white bg-indigo-400 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Lưu
              </button>
              <button id="btn-cancel" href="/admin/products" type="text" class="inline-flex justify-center py-2 px-4 border border-indigo-600 shadow-sm text-base font-medium rounded-md text-white bg-indigo-400 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Hủy
              </button>
            </div>
            </form>
